...
<script lang="ts">
  import {MyEl_FormItem, MyEl_FormItem_Rule_Config, MyElement_TableCol, MyFormItem_SelectOptionConf} from "@/_framework/sdk/ElementUI/MyElementUtils";
  import BaseVue, {MixinFather, MixinsInheritCompanion, MyAction, MyComponent, MyGetter, MyLog, MyMixins, MyMutation, MyProp, MyWatch} from "@/_framework/base/BaseVue";
  import CommonMixin from "@/_components/mixin/common-mixin";
  @MyComponent({
    name: "${NAME}",
    components: { /*组件*/
  ...
  export default class ${NAME}
    ...
    get tableCols(): any[] {
      return [
        {name: 'id', prop: 'id', label: 'ID'},
        {name: 'lastUpdateTime', prop: 'lastUpdateTime', label: '更新时间'},
        {
          name: 'operate', /*label: '操作', */ i18nKey: 'table.Operation', minWWidth: 120,
